# 1 "c:\\nt_school\\git\\loadrunner\\lr_script\\uc_03_cancel_itinerary\\\\combined_uc_03_cancel_itinerary.c"
...
# 1 "c:\\nt_school\\git\\loadrunner\\lr_script\\uc_03_cancel_itinerary\\\\combined_uc_03_cancel_itinerary.c" 2
...
# 1 "uc_03_cancel_itinerary.c" 1
uc_03_cancel_itinerary()
{
	int i;
	int flightidCount;
	char body[30000] = "";
	...
	lr_start_transaction("uc_03_cancel_itinerary");
	...
	lr_message(lr_eval_string("{BODY}"));
	...
	lr_end_transaction("cancel_itinerary", 2);
	
	lr_think_time(5);
	
	lr_end_transaction("uc_03_cancel_itinerary", 2);
